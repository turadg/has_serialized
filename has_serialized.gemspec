...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-05-20}
  s.description = %q{Adds dynamic attributes through serialize. This way it's still trivial to track changes to your app.}
  ...
  s.summary = %q{Adds dynamic attributes via serialize}
  s.test_files = [
    "spec/fixtures/category.rb",
    "spec/fixtures/page.rb",
    "spec/has_serialized_spec.rb",
